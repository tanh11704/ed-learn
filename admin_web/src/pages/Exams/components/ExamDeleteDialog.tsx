...
export default function ExamDeleteDialog({ isOpen, onClose, onConfirm, examTitle, isLoading }: ExamDeleteDialogProps) {
  return (
    <AnimatePresence>
      {isOpen && (
            ...
            <div className="p-6 space-y-4">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <p className="text-red-400 text-sm font-medium">
                  Bạn có chắc chắn muốn xóa đề thi <span className="font-bold">"{examTitle}"</span>?
                </p>
