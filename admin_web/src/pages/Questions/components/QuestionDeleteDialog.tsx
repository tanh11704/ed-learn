...
export default function QuestionDeleteDialog({ isOpen, onClose, onConfirm, questionContent, isLoading }: QuestionDeleteDialogProps) {
  return (
    <AnimatePresence>
      {isOpen && (
          ...
          >
            ...
            <div className="p-6 space-y-4">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <p className="text-red-300/70 text-xs mt-2 line-clamp-2">
                  "{questionContent}"
                </p>
