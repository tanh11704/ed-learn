...
export default function LessonDeleteDialog({ isOpen, onClose, onConfirm, lessonTitle, isLoading }: LessonDeleteDialogProps) {
  return (
    <AnimatePresence>
      {isOpen && (
            ...
            <div className="p-6 space-y-4">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <p className="text-red-400 text-sm font-medium">
                  Bạn có chắc chắn muốn xóa bài giảng <span className="font-bold">"{lessonTitle}"</span>?
                </p>
                <p className="text-red-300/70 text-xs mt-2">
                  Hành động này không thể hoàn tác. Bài giảng sẽ bị xóa vĩnh viễn.
                </p>
              </div>
