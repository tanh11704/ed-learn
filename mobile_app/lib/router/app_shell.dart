...
class AppShell extends StatefulWidget {
  ...
  static final GlobalKey<_AppShellState> _globalKey =
...
class _AppShellState extends State<AppShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: widget
          .navigationShell, // Hiển thị màn hình con tương ứng với tab được chọn
      ...
      bottomNavigationBar: _isBottomSheetOpen
          ? null
          : BottomAppBar(
              shape: showFab
                  ? const CircularNotchedRectangle()
                  : null, // Tạo rãnh lõm cho nút nổi
