...
public class BadgeAdminController {
    ...
    public ResponseEntity<BadgeResponse> create(@Valid @RequestBody CreateBadgeRequest request) {
        var badge =
                createBadgeUseCase.createBadge(
    ...
    public ResponseEntity<Page<BadgeResponse>> getAll(
        ...
        var badges =
                getAllBadgesUseCase.getAllBadges(
    ...
    public ResponseEntity<BadgeResponse> update(
            @PathVariable UUID id, @Valid @RequestBody UpdateBadgeRequest request) {
