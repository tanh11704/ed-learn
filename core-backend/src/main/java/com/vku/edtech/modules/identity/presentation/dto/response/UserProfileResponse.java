...
public record UserProfileResponse(
        @Schema(
                ...
                UUID id,
        @Schema(description = "Địa chỉ email đăng ký", example = "student@vku.udn.vn") String email,
        @Schema(description = "Họ và tên đầy đủ", example = "Nguyễn Văn A") String fullName,
