...
@Tag(name = "Xử lý Khóa học của Sinh viên", description = "Các thao tác đăng ký khóa học - Student API")
public class EnrollmentController {
    ...
    @Operation(
            ...
            description = "Đăng ký tham gia một khóa học. Tham số userId được lấy từ token đăng nhập để chống IDOR.",
